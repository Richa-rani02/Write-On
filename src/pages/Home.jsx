...
export const Home = () => {
    return (
        <div className="home flex w-screen h-screen flex-wrap">
            ...
            <Link to="/notes" type="button" class=" mt-5 text-white bg-gradient-to-r from-cyan-700 to-blue-500 hover:bg-gradient-to-bl focus:outline-none  font-medium rounded-lg text-lg px-5 py-2.5 text-center mr-2 mb-2">Start Writing ...</Link>
            </div>
