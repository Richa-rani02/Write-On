        ...
        <div className="notes bg-[#FAFAFA] h-full w-screen">
            ...
            <main className="px-3 py-2 lg:ml-64 ml-0 md:ml-64 relative">
                {/* <div class="flex flex-wrap lg:justify-between md:justify-between justify-center  items-center gap-4 mt-6 px-7 py-2 ">
                    ...
                    >
                        <button type="button" class="text-white mt-8 lg:mt-0  bg-cyan-700 hover:bg-cyan-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 relative" onClick={(e)=>{
                            tooglenotesModal(e);
                            setNotes(noteInput)
                            }}>
                           Add Notes
                ...
                <div class="flex flex-wrap justify-around mt-8 items-center gap-6">
                <div class="flex">
                        <button type="button" class="text-white bg-cyan-700 hover:bg-cyan-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 relative" onClick={(e)=>{
                            tooglenotesModal(e);
                            setNotes(noteInput)
                            }}>
                           Add Notes
                    ...
                    <div class="flex pr-6">
                        ...
                        />
                        <button type="button" class="text-white bg-cyan-500 hover:bg-cyan-800 focus:outline-none font-medium text-sm py-2.5 px-7 text-center inline-flex items-center dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800">
                            <MdTune size={24} />
                        </button>
                    </div>
